...
var projectRoot = getPath(".feflowrc.json");
...
var Builder = /*#__PURE__*/function () {
  ...
  _createClass(Builder, [{
    ...
    value: function mixCreateConfig(options) {
      ...
      mixPlugins.push(this.setDefinePlugin(options.envs, options.currentEnv)); // externals配置
      ...
      mixConfig.resolve.alias = this.setAlias(options.alias); // mixConfig.resolve.extensions = []
    ...
    key: "setExternalPlugin",
    value: function setExternalPlugin(externals) {
      var newExternals = externals; //   console.log(newExternals)

      return new _htmlWebpackExternalsPlugin["default"]({
